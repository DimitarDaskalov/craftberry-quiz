...
const Question4 = () => {
  ...
  const options = [
    ...
    { label: "c. Scalp dryness", value: "scalp dryness" },
      ...
      <QuestionWrapper>
        ...
        <Options>
          {options.map((option) => (
            <Option
              key={option.value}
              onClick={() => saveAnswer("q4", option.value)}
        ...
        <ButtonsWrapper>
          <BackButton to={"/question3"}>Back</BackButton>
          <NextButton to={"/question5"}>Next question ➝</NextButton>
        </ButtonsWrapper>
      </QuestionWrapper>
      <ProgressWrapper>
        <CircularProgressbar
